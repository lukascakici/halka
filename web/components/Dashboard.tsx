      ...
      <main className="mx-auto w-full max-w-5xl flex-1 px-5 py-12 sm:py-16">
        <div className="max-w-2xl">
          ...
          <p className="mt-4 text-lg leading-8 text-zinc-600">
            Halka turns the trusted savings circle into a transparent protocol
            on Stellar. This is Level 1 — connect your wallet, check your
            balance, and make your first contribution on {NETWORK.label}.
          </p>
        </div>
        ...
        {isWrongNetwork && (
          <div className="mt-8 flex items-start gap-2.5 rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm text-amber-800">
            ...
            <span>
              Your wallet is on a different network. Switch Freighter to{" "}
        ...
        {connected ? (
          ...
          <div className="mt-10 rounded-2xl border border-zinc-200 p-10 text-center">
            ...
            <p className="mx-auto mt-2 max-w-md text-zinc-600">
              Halka uses the Freighter wallet on the Stellar {NETWORK.label}.
              Connect to view your balance and send a contribution.
            </p>
            <button
              type="button"
